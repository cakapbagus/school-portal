...
export async function initDb() {
  ...
  // folder_links junction: prefix fl_
  await db.execute(`CREATE TABLE IF NOT EXISTS folder_links (
    fl_folder_id INTEGER NOT NULL,
    fl_link_id   INTEGER NOT NULL,
    fl_position  INTEGER DEFAULT 0,
    PRIMARY KEY (fl_folder_id, fl_link_id)
  )`);
